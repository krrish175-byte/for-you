...
export function LetterScreen() {
    const paragraphs = [
        ...
        "I know we might have differences, like me being from West Bengal and growing up eating non-veg. But I want you to know that I deeply respect your lifestyle. In fact, I have already been trying to control it, and for you, adapting completely is something I would do willingly and happily.",
