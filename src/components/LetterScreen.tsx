...
export function LetterScreen() {
    const paragraphs = [
        ...
        "I would love nothing more than to get to know you better. I know how seriously you take your studies, and I respect that completely. I'd only ever want to be your biggest supporter, never a distraction. We can study together, or just hang out when you need a break.",
        "This is the first time I have ever done something like this, so I might not have all the perfect words. But simply put, I just want to see you smile and be someone you can rely on.",
        ...
        "Take all the time you need to think about it. Thank you for reading this far, and for being patient with me. I'll be waiting for your answer, whenever you're ready."
    ];
